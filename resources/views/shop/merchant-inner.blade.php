                ...
                <div class="row gutter-50">
                    ...
                    <div class="col-lg-7 portfolio-single-image">
                        ...
                        <div class="masonry-thumbs grid-container masonry-gap-xl grid-1 grid-md-2" data-lightbox="gallery">
                            <h2 style="font-size:1.5rem;" class="font-secondary color text-center">Latest Instagram Feed</h2>
{{--                            <a href="{{ Storage::disk('public')->url($shop->cover_image) }}" data-lightbox="gallery-item" class="grid-item">--}}
{{--                                <img style="object-fit: none; object-position: center;" class="rounded-xxl" src="{{ Storage::disk('public')->url($shop->cover_image) }}" alt="{{ $shop->name }}">--}}
{{--                            </a>--}}
                    ...
                    <div class="col-lg-5 portfolio-single-content content-sticky">
                        ...
                        ============================================= -->
                        <h2 class="font-secondary color">{{ $shop->name }}</h2>
